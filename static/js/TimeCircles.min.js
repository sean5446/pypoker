...
var _this=this;this.data.interval_fallback=useWindow.setInterval(function(){_this.update.call(_this,!0)},100)};TC_Instance.prototype.update=function(nodraw){if(typeof nodraw==="undefined"){nodraw=!1}
...
$.extend(!0,this.config,options);if(this.config.use_top_frame){useWindow=window.top}
